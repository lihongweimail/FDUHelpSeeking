...
public class SimpleGCSEBrowser implements ControlListener {
...
//		Authorization: GoogleLogin auth=IM6F7Cx2fo0TAiwlhNVdSE8Ov8hw6aHV
	...
	public String getAuthenticatedString()
	{
		...
		buffer.append("GET http://www.google.com/cse/api/<USER_ID>/cse/<CSE_ID>");

		
		return "";
	}
	
	public String constructAnnotationContext() {
		StringBuffer buffer = new StringBuffer();

		buffer.append("POST http://www.google.com/cse/api/<USER_ID>/cse/<CSE_ID>my_first_cse");
		buffer.append("Content-Type: text/xml");
		buffer.append("Authorization: GoogleLogin auth=\"IM6F7Cx2fo0TAiwlhNVdSE8Ov8hw6aHV\"");
		buffer.append("<CustomSearchEngine keywords=\"cars\" language=\"en\">");
		buffer.append("<Title>My First CSE</Title>");
		buffer.append("<Description>Car Search</Description>");
		buffer.append("<Context>");
		buffer.append("<BackgroundLabels>");
		buffer.append("<Label name=\"_cse_my_first_cse\" mode=\"FILTER\" />");
		buffer.append("<Label name=\"_cse_exclude_my_first_cse\" mode=\"ELIMINATE\" />");
		buffer.append("</BackgroundLabels>");
		buffer.append("</Context>");
		buffer.append("<LookAndFeel nonprofit=\"false\" />");
		buffer.append("</CustomSearchEngine>");
	...
	public SimpleGCSEBrowser(Composite composite) {
...
//		System.out.println("the new url: "+ browser.getText());
	...
	public static void main(String[] args) {
		...
		SimpleGCSEBrowser thisClass = new SimpleGCSEBrowser(composite);
