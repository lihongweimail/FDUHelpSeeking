...
public class Basic {
	...
	public final static int GOOGLE_RESULT_NUMBERS = 10; // default 10 to get 10
														// urls ; values as
														// 1--10
	public final static int GOOGLE_SEARCH_ROUND = 3; // default 10 for get 100
														// url ; test as 1 for
														// 10 url

	public static INIHelper mycseini = new INIHelper("/cse.ini", true);
	public final static List<CxKeyPair> ALL_CX_KEY_PAIRS = mycseini
			.getCxKeyPairs();
	// CommUtil.getKeyCx();
	public static final int historyQueryWindowCount = 3;

	public final static int FOAMTREETOPICCOUNT = 6; // 提供给foamtree2
													// （右下）的topic的数量
	public final static int FOAMTREETOPICWORDSLIMITIED = 6; // 每个topic 中提取出前六个词
	public static final int DISPLAYTOPICFOAMTREEPLAN = 2; // 值为1 或其他值
	...
	public static double RATIOOFNEWSEARCHSTRING = 0.24; // 给定一个值，两个串中的不相同的词大于这个值，则容许刷新新的一组关键词
	...
	public static final long CLAWLIMITEDTIME = 5000;// 爬取网络页面时，等待的时间
													// 毫秒，超时后，就放弃，以改善交互
	public static int ALGORITHMSELECTION = 2; // 算法设置，1为5月份的算法的关键词数据初值设置， 2
												// 为11月新算法的关键词初值设置
	...
	public static int CLAWMODE = 1; // 爬取网页的技术 1：使用线程池 2：使用GBK编码获取网页，非线程 3：
									// 雪娇提供的stringbean方案
	...
	// public final static String[][] cssColor = { { "AliceBlue", "#F0F8FF" },
