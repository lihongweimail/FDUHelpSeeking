...
//				locationText.setText(e.location);
		...
		browser.addProgressListener(new ProgressListener() {
			...
			public void completed(ProgressEvent e) {
				...
				//设置高亮，运行页面中内置的高亮代码应该放在这里：2015.1.27
				//之前已经设置了当前的具有了高亮javascript脚本的网页：browser.seturl ("http://www.nsftools.com/misc/SearchAndHighlight.htm");
				//browser.execute ("highlightSearchTerms('highlight');");
...
//		 System.out.println("width:"+width+"height"+height+"x"+x+"y"+y);
	...
	//  参考http://www.nsftools.com/misc/SearchAndHighlight.htm
	//  http://www.eclipse.org/forums/index.php/t/163057/
	// 为了实现浏览器高亮词汇，需要在HTML文件中的<head>中添加如下的脚本；并在<body>中的onload时调用如下的函数。： 2015.1.27
	//  方式有两种：
	// 方式一：直接使用   <body onload="highlightSearchTerms('search');">
    // 方式二：放在按钮上 
	//<br>
