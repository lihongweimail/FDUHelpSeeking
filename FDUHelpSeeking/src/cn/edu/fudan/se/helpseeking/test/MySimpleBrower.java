...
public class MySimpleBrower  implements ControlListener
{
...
//    
    ...
    public MySimpleBrower(Composite composite) {
    	setMyComposite(composite);
	}
    public MySimpleBrower() {
    	super();
	}
...
//                sShell.setText(APP_TITLE + " - " + e.title);  
    ...
    public static void main(String[] args) {  
		...
		MySimpleBrower thisClass = new MySimpleBrower(composite);
