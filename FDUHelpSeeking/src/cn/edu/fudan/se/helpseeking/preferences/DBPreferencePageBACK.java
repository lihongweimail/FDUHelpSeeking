...
public class DBPreferencePageBACK extends PreferencePage     implements IWorkbenchPreferencePage, ModifyListener {  
...
//		public static final String PASSWORD_DEFAULT = "root";     
	// move to PreferenceConstants.java
	...
	{         
		...
		String url = ps.getString(PreferenceConstants.URL_KEY);

		if (url == null || url.trim().equals(""))
			urlText.setText(PreferenceConstants.URL_DEFAULT); 
		else 
			urlText.setText(url);  
		String username = ps.getString(PreferenceConstants.USERNAME_KEY); 
		if (username == null || username.trim().equals(""))  
			usernameText.setText(PreferenceConstants.USERNAME_DEFAULT);  
		else 
			usernameText.setText(username);  
		String password = ps.getString(PreferenceConstants.PASSWORD_KEY);    
		if (password == null || password.trim().equals("")) 
			passwordText.setText(PreferenceConstants.PASSWORD_DEFAULT);   
		else 
	...
	private void doSave() 
	{          
		ps.setValue(PreferenceConstants.URL_KEY, urlText.getText());      
		ps.setValue(PreferenceConstants.USERNAME_KEY, usernameText.getText());    
		ps.setValue(PreferenceConstants.PASSWORD_KEY, passwordText.getText());   
	}
